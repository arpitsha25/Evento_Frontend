      ...
      <div className="container">
        ...
        <div className="c-2 grid">
          <Sformat
            ...
            image={bg2}
            style = {{ background: 'linear-gradient(105deg, blue , green)' }}
          />
        </div>
        {/* ------------------------------------ */}
        <div className="c-3 grid">
          <Sformat
            ...
            image={bg3}
            style = {{ background: 'linear-gradient(105deg, red , yellow)' }}
          />
        </div>
        {/* -------------------------------- */}
        <div className="c-4 grid">
          <Sformat
            ...
            image={bg4}
            style = {{ background: 'linear-gradient(105deg, cornflowerblue , firebrick)' }}
          />
        </div>
        {/* -------------------------------- */}
        <div className="c-5 grid">
          <Sformat
            ...
            image={bg5}
            style = {{ background: 'linear-gradient(105deg, red , blue)' }}
          />
        </div>
        {/* -------------------------------- */}
        <div className="c-6 grid">
          <Sformat
            ...
            image={bg6}
            style = {{ background: 'linear-gradient(105deg, red , pink)' }}
          />
        </div>
        {/* -------------------------------- */}
      </div>
